    ...
    <Row gutter={24}>
        ...
        <ChartCard
          ...
          footer={
            <Field
              label={
                <FormattedMessage
                  id="app.analysis.day-workorder"
                  defaultMessage="Daily Workorder"
                />
              }
      ...
      <Col {...topColResponsiveProps}>
        <ChartCard
          title={
            <FormattedMessage
              id="app.analysis.workorder-ground"
              defaultMessage="Workorder Ground"
            />
          }
          action={
            <Tooltip
          ...
          loading={loading}
          total={() => BadWorkorderTotal}
          footer={
            <Field
              label={
                <FormattedMessage
                  id="app.analysis.day-workorder-ground"
                  defaultMessage="Daily Workorder Ground"
                />
              }
      ...
      <Col {...topColResponsiveProps}>
        <ChartCard
          title={
            <FormattedMessage
              id="app.analysis.workorder-complete"
              defaultMessage="Workorder Complete"
            />
          }
          action={
            <Tooltip
          ...
          loading={loading}
          total={() => GoodWorkorderTotal}
          footer={
            <Field
              label={
                <FormattedMessage
                  id="app.analysis.day-workorder-complete"
                  defaultMessage="Daily Workorder Complete"
                />
              }
