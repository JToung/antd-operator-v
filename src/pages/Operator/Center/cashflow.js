      ...
      return (
        ...
        >
          <Descriptions bordered layout="vertical">
            ...
            <Descriptions.Item label="工单id">{Contract.workOrderId}</Descriptions.Item>
            <Descriptions.Item label="产生时间">
              <span>{moment(Contract.timestamp).format('YYYY-MM-DD HH:mm:ss')}</span>
            </Descriptions.Item>
            <Descriptions.Item label="运营商所得">{Contract.operatorReceivable}</Descriptions.Item>
  ...
  renderSimpleForm() {
    ...
    return (
      <Form onSubmit={this.handleSearch} layout="inline">
        ...
        <Col md={8} sm={24}>
            <FormItem label="专才ID">
              {getFieldDecorator('servicerId')(<Input placeholder="请输入" />)}
            </FormItem>
          </Col>
          <Col md={8} sm={24}>
            <FormItem label="结算状态">
